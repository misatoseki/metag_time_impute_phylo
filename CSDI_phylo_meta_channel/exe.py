...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_path", type=str, default="../indata/rel-species-table_clr_tab.csv")
    parser.add_argument("--mask_path", type=str, default="../indata/mask_0.1.csv")
